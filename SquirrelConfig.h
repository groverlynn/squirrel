...
@property(nonatomic, strong, readonly, nullable) NSArray<NSString *> *optionNames;
@property(nonatomic, strong, readonly, nullable) NSArray<NSString *> *optionStates;
@property(nonatomic, strong, readonly, nullable) NSDictionary<NSString *, NSArray<NSString *> *> *optionGroups;
@property(nonatomic, strong, readonly, nullable) NSDictionary<NSString *, NSString *> *switcher;
...
- (instancetype _Nonnull)initWithSchemaId:(NSString * _Nonnull)schemaId
                             ...
                             optionGroups:(NSDictionary<NSString *, NSArray<NSString *> *> * _Nullable)optionGroups;
